...
fn brc20_deploy() {
    ...
    let txid: Vec<u8> = hex("021928ceadf885627b57d89b75d4e868601fec7f8212ee535e64c02cf86638df")
        .into_iter()
        .rev()
        .collect();
    ...
    let tx1 = Proto::Input {
        ...
        to_recipient: ProtoInputRecipient::builder(Proto::mod_Input::InputBuilder {
            variant: ProtoInputBuilder::brc20_deploy(Proto::mod_Input::InputBrc20Deploy {
                one_prevout: false,
                pubkey: alice_pubkey.as_slice().into(),
                ticker: p_ticker,
                max: p_max,
